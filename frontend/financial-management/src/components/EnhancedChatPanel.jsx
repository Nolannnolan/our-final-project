...
const EnhancedChatPanel = () => {
  ...
  return (
    <div className="w-full bg-white h-full flex flex-col relative">
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              {conversations.length > 0 && (
                <span className="absolute -top-1 -right-1 w-4 h-4 bg-[#875cf5] text-white text-xs rounded-full flex items-center justify-center">
      ...
      {/* History Sidebar */}
      {showHistory && (
        <div className="absolute top-16 right-4 w-80 max-h-[500px] bg-white rounded-lg shadow-xl border border-gray-200 z-50 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {!currentConversation ? (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <button
              onClick={handleCreateConversation}
              className="px-6 py-3 bg-[#875cf5] text-white rounded-lg hover:bg-[#7049d0] flex items-center gap-2"
            >
