...
const NewsCard = ({title, source, pubDate, image, link, logo}) => {
  return (
    ...
    <a href={link} target='_blank'>
        <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300  group my-4 ">
            ...
            <div className="p-4">
                ...
                <div className="flex items-center justify-between text-sm text-gray-500 mt-5 text-[12px]">
